...
$subCat = $scanCode . $printCode . $faxCode . $jamCode . $imageCode . $serviceCode; //combine
...
$( document ).ready(function() {
	...
	if (r == true) {window.location.href='index.php';
		return false;}else{window.location.href='index.php';
		return false;}
	})
</script>";
</body>
